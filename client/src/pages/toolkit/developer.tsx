      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <div className="w-20 h-20 bg-blue-500/20 rounded-2xl flex items-center justify-center mx-auto mb-6 border border-blue-500/30">
            <ToolIcon toolId="json-formatter" className="w-8 h-8 text-blue-400" />
          </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {toolkit.tools.map((tool) => (
            <Card key={tool.id} className="bg-gray-800 border-gray-700 hover:bg-gray-750 hover:border-blue-500/50 transition-all duration-300">
              <CardContent className="p-6">
                <Link href={tool.route}>
                  <div className="w-12 h-12 bg-blue-500/20 rounded-lg flex items-center justify-center mb-4 border border-blue-500/30">
                    <ToolIcon toolId={tool.id} className="w-6 h-6 text-blue-400" />
                  </div>
        ...
        <div className="mt-16">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="font-semibold text-white mb-2">Boost Productivity</h3>
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-purple-500/20 rounded-full flex items-center justify-center mx-auto mb-4 border border-purple-500/30">
                <i className="fas fa-tools text-2xl text-purple-400"></i>
              </div>
              <h3 className="font-semibold text-white mb-2">All-in-One</h3>
              <p className="text-gray-300">
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-orange-500/20 rounded-full flex items-center justify-center mx-auto mb-4 border border-orange-500/30">
                <i className="fas fa-shield-alt text-2xl text-orange-400"></i>
              </div>
