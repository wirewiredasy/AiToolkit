...
export default function ImageToolkit() {
  ...
  const imageTools = [
    ...
    { id: 'image-filter', name: 'Image Filters', description: 'Apply filters and effects', icon: 'fas fa-palette', route: '/tool/image-filter' },
    { id: 'image-enhance', name: 'Image Enhancer', description: 'Enhance image quality with AI', icon: 'fas fa-adjust', route: '/tool/image-enhance' },
