...
export default function PDFToWord() {
  ...
  const convertPDF = useMutation({
    mutationFn: async (file: File) => {
      ...
      return apiRequest('/api/tools/pdf-to-word', {
        method: 'POST',
        body: formData,
      });
    },
    onSuccess: (data: any) => {
      if (data.success) {
        ...
        link.download = data.filename || 'converted.docx';
        link.click();
        toast({
  ...
  const handleConvert = () => {
    if (!user) {
      toast({
        ...
        description: "Please log in to convert PDF to Word",
        variant: "destructive",
      });
      return;
    }
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-muted-foreground">
            Convert PDF files to editable Word documents with perfect formatting
          </p>
        </div>
          ...
          <div className="lg:col-span-2">
            <Card className="backdrop-blur-sm bg-white/80 dark:bg-gray-800/80 border-0 shadow-xl">
              <CardHeader>
                ...
                <CardDescription>
                  Select a PDF file to convert to Word format (.docx)
                </CardDescription>
              </CardHeader>
            ...
            <Card className="backdrop-blur-sm bg-white/80 dark:bg-gray-800/80 border-0 shadow-xl">
              ...
              <CardContent>
                <div className="space-y-2 text-sm">
                  <div><strong>Input:</strong> PDF (.pdf)</div>
                  <div><strong>Output:</strong> Microsoft Word (.docx)</div>
                </div>
              </CardContent>
            </Card>
          </div>
