        ...
        <div className="max-w-4xl mx-auto">
          ...
          <Card className="shadow-xl border-0 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm">
            <CardHeader>
              ...
              <CardDescription>
                Upload a video file and adjust compression settings
              </CardDescription>
            </CardHeader>
              ...
              {result && (
                <div className="bg-green-50 dark:bg-green-900/20 p-4 rounded-lg">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <CheckCircle className="h-5 w-5 text-green-500" />
                      <span className="font-medium">Video compressed successfully!</span>
                    </div>
              ...
              <div className="grid md:grid-cols-3 gap-4 mt-8">
                <div className="bg-gradient-to-r from-blue-500/10 to-cyan-500/10 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-300">
                    Advanced algorithms preserve video quality
                  </p>
                </div>
                <div className="bg-gradient-to-r from-blue-500/10 to-cyan-500/10 p-4 rounded-lg">
                  <h3 className="font-semibold text-gray-900 dark:text-white mb-2">
