...
import {
  ...
  Calendar, Clock, MapPin, Phone, Mail, Car,
...
export const toolIcons: Record<string, any> = {
  ...
  'voter-id-validator': Flag,
  'passport-validator': Globe,
  'driving-license-validator': Car,
  'ifsc-validator': Building,
  'cin-validator': FileCheck,
  'udyam-validator': Award,
  'tan-validator': Hash,
  'esi-validator': Shield,
  'pf-validator': Building,
  'uan-validator': UserCheck,
  'fssai-validator': Award,
  'shop-act-validator': Building,
  'income-certificate': Award,
  'birth-certificate': Calendar,
  'death-certificate': Clock,
  'caste-certificate': FileCheck,
  'domicile-certificate': Flag,
  'marriage-certificate': Award,
  'character-certificate': CheckCircle,
